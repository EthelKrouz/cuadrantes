document.addEventListener('DOMContentLoaded', function() {
    ...
    async function captureAndDownloadNames(bgColor) {
        ...
        function createNameList(names, color) {
            return names.map(function(name) {
                return '<li style="font-size: 24px; line-height: 1.0; margin: 2px 0; font-weight: 300; color: ' + color + ';">' + name.nombre + '</li>';
            }).join('');
        };
        ...
        var quadrantStyle = 'width: 50%; height: 50%; display: flex; justify-content: center; align-items: center; flex-direction: column; padding: 20px; box-sizing: border-box; text-align: center;';
